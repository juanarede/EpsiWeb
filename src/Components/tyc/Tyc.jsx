...
function Tyc() {
  return (
    <>
      <div
        class="modal fade pt-4 modal-centrado "
        id="staticBackdrop"
        ...
        <div class="modal-dialog modal-dialog-scrollable ">
          <div class="modal-content bg-black">
            ...
            <div class="modal-body">
              <h4 style={{ color: "#fff" }}>Términos y condiciones</h4>
              <p style={{ color: "#fff" }}>
                ¡Bienvenido a epsiweb.com! Estos términos y condiciones
                describen las reglas y regulaciones para el uso del sitio web de
                EpsiWeb, ubicado en <a>https://epsiweb.com</a> . Al acceder a
                este sitio web, asumimos que aceptas estos términos y
                condiciones. No continúes usando epsiweb.com si no estás de
                acuerdo con todos los términos y condiciones establecidos en
                esta página.
              </p>
              <p style={{ color: "#fff" }}>
                Al acceder a este sitio web, asumimos que aceptas estos términos
                y condiciones. No continúes usando epsiweb.com si no estás de
                acuerdo con todos los términos y condiciones establecidos en
                esta página.
              </p>
              ...
              <p style={{ color: "#fff" }}>
                ...
                experiencia en línea. Al acceder a epsiweb.com, aceptaste
              ...
              <p style={{ color: "#fff" }}>
                ...
                ejecutar programas o enviar virus a tu computadora. Las cookies
                se te asignan de forma exclusiva y solo un servidor web en el
                dominio que emitió la cookie puede leerlas.
              </p>
              <p style={{ color: "#fff" }}>
                ...
                servicios proporcionados por terceros si utilizas dichos
                servicios en nuestro sitio web, por ejemplo, una ventana de
                visualización de video proporcionada por terceros e integrada en
                nuestro sitio web.
              </p>
              <h4 style={{ color: "#fff" }}>Licencia:</h4>
              <p style={{ color: "#fff" }}>
                A menos que se indique lo contrario, EpsiWeb y/o sus
                licenciantes poseen los derechos de propiedad intelectual de
                todo el material en epsiweb.com. Todos los derechos de propiedad
                intelectual son reservados. Puedes acceder desde epsiweb.com
                para tu uso personal sujeto a las restricciones establecidas en
                estos términos y condiciones.
              </p>
              <p style={{ color: "#fff" }}>No debes:</p>
              <ul>
                <li>Copiar o volver a publicar material de epsiweb.com</li>
                <li>Vender, alquilar o sublicenciar material de epsiweb.com</li>
                <li>Reproducir, duplicar o copiar material de epsiweb.com</li>
                <li>
                  Redistribuir contenido de epsiweb.com Este acuerdo comenzará
                  el fecha presente.
                </li>
              </ul>
              <p style={{ color: "#fff" }}>
                ...
                determinadas áreas. EpsiWeb no filtra, edita, publica ni revisa
                los comentarios antes de su presencia en el sitio web. Los
                comentarios no reflejan los puntos de vista ni las opiniones de
                EpsiWeb, sus agentes y/o afiliados. Los comentarios reflejan los
                puntos de vista y opiniones de la persona que publica. En la
                medida en que lo permitan las leyes aplicables, EpsiWeb no será
                responsable de los comentarios ni de ninguna responsabilidad,
                daños o gastos causados ​​o sufridos como resultado de cualquier
                uso o publicación o apariencia de comentarios en este sitio web.
              </p>
              <p style={{ color: "#fff" }}>
                EpsiWeb se reserva el derecho de monitorear todos los
                comentarios y eliminar los que puedan considerarse inapropiados,
                ofensivos o que incumplan estos Términos y Condiciones.
              </p>
              <p style={{ color: "#fff" }}>Garantizas y declaras que:</p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  o actividades ilegales. Por la presente, otorgas a EpsiWeb una
                  licencia no exclusiva para usar, reproducir, editar y
                  autorizar a otros a usar, reproducir y editar cualquiera de
                  tus comentarios en todas y cada una de las formas, formatos, o
                  medios.
                </li>
              </ul>
              <h4 style={{ color: "#fff" }}>
              ...
              <ul>
                ...
                <li>
                  ...
                  organizaciones sin fines de lucro, centros comerciales de
                  caridad y grupos de recaudación de fondos de caridad que no
                  pueden hacer hipervínculos a nuestro sitio web. Estas
                  organizaciones pueden enlazar a nuestra página de inicio, a
                  publicaciones o a otra información del sitio siempre que el
                  enlace: (a) no sea engañoso de ninguna manera; (b) no implique
              ...
              <ul>
                ...
                <li>
                  ...
                  compensa la ausencia de EpsiWeb; y (d) el enlace está en el
              ...
              <p style={{ color: "#fff" }}>
                ...
                (b) no implique falsamente patrocinio, respaldo o aprobación de
                la parte vinculante y sus productos o servicios; y (c) encaja en
              ...
              <p style={{ color: "#fff" }}>
                ...
                informarnos enviando un correo electrónico a EpsiWeb. Incluye tu
                nombre, el nombre de tu organización, la información de
                contacto, así como la URL de tu sitio, una lista de las URL
                desde las que tienes la intención de vincular a nuestro sitio
                web y una lista de las URL de nuestro sitio a las que te
              ...
              <ul>
                ...
                <li>
                  Usar cualquier otra descripción de nuestro sitio web al que
                  está vinculado que tenga sentido dentro del contexto y formato
                  del contenido en el sitio de la parte vinculante. No se
                  permitirá el uso del logotipo de EpsiWeb u otro material
                  gráfico para vincular sin un acuerdo de licencia de marca
                  comercial.
                </li>
              </ul>
              <h4 style={{ color: "#fff" }}>Responsabilidad del contenido:</h4>
              <p style={{ color: "#fff" }}>
                ...
                viole o defienda la infracción u otra violación de los derechos
                de terceros.
              </p>

              <h4 style={{ color: "#fff" }}>Reserva de derechos:</h4>
              <p style={{ color: "#fff" }}>
                ...
                modificar estos términos y condiciones y su política de enlaces
                en cualquier momento. Al vincular continuamente a nuestro sitio
                web, aceptas estar vinculado y seguir estos términos y
              ...
              <p style={{ color: "#fff" }}>
                ...
                correcta. No garantizamos su integridad o precisión, ni
                prometemos asegurarnos de que el sitio web permanezca disponible
                o que el material en el sitio se mantenga actualizado.
              </p>
              <h4 style={{ color: "#fff" }}>Exención de responsabilidad:</h4>
              <p style={{ color: "#fff" }}>
              ...
              <ul>
                ...
                <li>
                  excluirá cualquiera de nuestras responsabilidades o las tuyas
                  que no puedan estar excluidas según la ley aplicable. Las
                  limitaciones y prohibiciones de responsabilidad establecidas
                  en esta sección y en otras partes de este descargo de
                  responsabilidad: (a) están sujetas al párrafo anterior; y (b)
                  regirá todas las responsabilidades que surjan en virtud de la
                  exención de responsabilidad, incluidas las responsabilidades
                  que surjan en el contrato, en agravio y por incumplimiento de
                  la obligación legal.
                </li>
              </ul>
              <p style={{ color: "#fff" }}>
